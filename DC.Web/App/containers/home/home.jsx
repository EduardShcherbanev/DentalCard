...
export default class Home extends React.Component {
    render() {
        return (
            <div>
                <section>
                    <h3 className="primary-text center">Врач-стоматолог терапевт, хирург, ортопед</h3>
                </section>
                ...
                <section>
                    <Row>
                        ...
                        <Col s={12} m={6}>
                            <h3 className="primary-text">Заголовок</h3>
                ...
                <section>
                    <Row>
                        <Col s={12} m={6}>
                            <h3 className="primary-text">Глубокий смысл</h3>
